package com.example.kyc.config.security;

import com.example.kyc.config.ConfigConstants;
import com.example.kyc.config.filters.JwtAuthenticationFilter;
import com.example.kyc.config.jwt.JwtAuthEntryPoint;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(ConfigConstants.EXCLUDE_AUTH_URLS).permitAll()
