...
public interface ClientApiPermissionRepository extends JpaRepository<SysAccClientApiPermission, Long> {
    ...
    @Query("""
            ...
            from SysAccClientApiPermission permission
    ...
    @Query("delete from SysAccClientApiPermission permission where permission.clientApplication.id = :clientApplicationId")
