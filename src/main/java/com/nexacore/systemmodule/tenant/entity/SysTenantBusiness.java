...
@Entity @Table(name="sys_tenant_businesses") @Getter @Setter
public class SysTenantBusiness extends ActionInfo {
    @Id @GeneratedValue(strategy=GenerationType.IDENTITY) private Long id;
    @Column(name="tenant_id",nullable=false) private Long tenantId;
    @Column(name="business_code",nullable=false) private String businessCode;
