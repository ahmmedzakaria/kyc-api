...
public interface AdministrativeBoundariesLevel5Repository extends JpaRepository<GisAdministrativeBoundariesLevel5, java.util.UUID> {

    @Query("""
        SELECT a FROM GisAdministrativeBoundariesLevel5 a
        WHERE
        ...
        """)
    Page<GisAdministrativeBoundariesLevel5> searchByAnyLevel(String search, Pageable pageable);
}
