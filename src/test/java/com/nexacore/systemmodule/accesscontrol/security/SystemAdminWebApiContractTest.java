...
class SystemAdminWebApiContractTest {
    ...
    private static final Map<String, String> REQUIRED_APIS = Map.ofEntries(
            ...
            Map.entry("POST:/api/v1/system/api-registry/sync/preview", "11020100680"),
            Map.entry("POST:/api/v1/system/api-registry/sync/apply", "11020100680"),
            Map.entry("POST:/api/v1/system/api-registry/search", "11020100601"),
            Map.entry("POST:/api/v1/system/api-registry/inventory/search", "11020100601"),
            Map.entry("POST:/api/v1/system/user/list", "11020100701"),
            Map.entry("POST:/api/v1/system/user/detail", "11020100701"),
            Map.entry("POST:/api/v1/system/user/role-assignments", "11020100701"),
            ...
            Map.entry("POST:/api/v1/system/role/detail", "11020100801"),
            Map.entry("POST:/api/v1/system/role/privilege-assignments", "11020100801"),
            Map.entry("POST:/api/v1/system/role/save", "11020100887"),
            Map.entry("POST:/api/v1/system/tenants/list", "11020100901"),
            Map.entry("POST:/api/v1/system/tenants/authorized", "AUTHENTICATED"),
            Map.entry("POST:/api/v1/system/tenants/businesses", "AUTHENTICATED"),
            Map.entry("POST:/api/v1/system/tenants/branches", "AUTHENTICATED"),
            Map.entry("POST:/api/v1/system/privilege/list", "11010100101"),
            Map.entry("POST:/api/v1/system/privilege/search", "11010100101"),
            Map.entry("POST:/api/v1/system/privilege/impact", "11010100101"),
            Map.entry("POST:/api/v1/system/privilege/deactivate", "11010100180"),
